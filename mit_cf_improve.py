...
x_data = pd.read_csv('./2k_fibro_0317.csv')
y_data = pd.read_csv('./2k_fibro_labels_0317.csv')
distance = pd.read_csv('./dis_mat_6742_0317.csv')


distance = distance.to_numpy()
distance = distance[:,1:]
distance = np.transpose(distance) + distance
